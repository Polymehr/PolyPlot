#PolyPlot Base16 solarised theme dark 

graphics.cheat-sheet.background=B8
graphics.cheat-sheet.foreground=FF
graphics.color.background=FDF6E3FF
graphics.debug.foreground=E0
graphics.function-overview.background=A0
graphics.function-overview.foreground=FF
graphics.functions.colors=[DC322F, CB4B16, B58900, 859900, 2AA198, 268BD2, 6C71C4, D33682]
...
graphics.input.output-color.error=DC322F
graphics.input.output-color.output=2AA198
graphics.scale.color=586E75FF
