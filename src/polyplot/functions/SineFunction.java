...
/**
 * A sine function with the formula:
 * <pre>
 *      f(x) = a*sin(b*x+c)+d
 * </pre>
 * 
 ...
 */
public class SineFunction extends TrigonometricFunction {

  /**
   * Constructs a new SineFunction from a function in a String.<br>
   ...
   *    <code>null</code>.
   */
  public SineFunction(String function) {
    super(function, "sin");
  }

  /**
   * Constructs a new SineFunction from the given <code>a</code>, <code>b</code>,
  ...
  private double getRoot0(int n) {
    return 1/b*(2*Math.PI*n-c-Math.asin(d/a));
  }
  ...
  private double getRoot1(int n) {
    return 1/b*(2*Math.PI*n+Math.PI-c+Math.asin(d/a));
  }
