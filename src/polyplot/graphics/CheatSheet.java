 ...
 * @author Jannik
 */
public class CheatSheet extends DrawableComponent implements Hideable {
    ...
    public void draw(Graphics gc, FunctionPlotter parent) {
        ...
        final String[][] data = {movement, zoom, view};
        ...
        Font titles = origin.deriveFont(underline);
        ...
        gc.setFont(origin.deriveFont(Font.BOLD).deriveFont(underline));
